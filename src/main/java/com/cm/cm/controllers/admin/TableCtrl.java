...
public class TableCtrl implements Initializable {
    ...
    public static ObservableList<TableModel> loadTable() {
        ...
        try {
            ...
            while (res.next()) {
                ...
                loadList.add(new TableModel(res.getString("id"), res.getString("name"), res.getString("detail"),
                        res.getString("units_used"), res.getString("units_left"), res.getString("unit_price"),
    ...
    public static ObservableList<TableModel> searchDB(String query, Window owner) {
        ...
        try (Connection conn = Psql.connector();
            ...
            try {
                while (res.next()) {
                    queryList.add(new TableModel(res.getString("id"), res.getString("name"), res.getString("detail"),
                            res.getString("units_used"), res.getString("units_left"), res.getString("unit_price"),
                            res.getString("restock")));
                }
    ...
    private void confirm_update() {
        try {
//      Psql.updateValues(side_name_entry.getText(), side_detail_entry.getText(), side_units_used_entry.getText(),
//          side_units_left_entry.getText(), side_unit_price_entry.getText(), side_restock_entry.getText(),
